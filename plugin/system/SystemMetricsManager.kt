package me.innerworks.capacitor.plugin.system
...
import me.innerworks.capacitor.plugin.system.root_checker.RootCheckManager
...
internal class SystemMetricsManager(context: Context) {
    ...
    private val mediaDrm:MediaDrm by lazy {
